        ...
        <View>
          ...
          <View style={styles.medicalHistoryContainer}>
            ...
            <Text style={styles.medicalHistorySubTitle}>
              Conditions: Potential Malaria Viral Pharyngitis Indigestion
            </Text>
        ...
        <View>
          <View style={styles.encounterContainer}>
            ...
            <View style={styles.encounterCard}>
              ...
              <Text>Name: Pepto-Bismol</Text>
              <Text>Dosage: Not specified</Text>
              <Text>Frequency: Four times a day</Text>
              <Text>Duration: Five days</Text>
            </View>
            <View style={styles.encounterCard}>
              <Text style={styles.encounterSectionTitle}>Subjective</Text>
              <Text>Chief Complaint: Stomach pain since last night.</Text>
              <Text>
